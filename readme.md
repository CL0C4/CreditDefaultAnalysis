...
- Uses StandardScaler to ensure that naturally larger numbers are not necessarily treated as more important (i.e. ensures that credit limit, which could scale to 100,000+, is not immediately deemed more important than age, which will realistically only approach ~80)
